...
class SepaMandate:
    ...
    def __init__(self, owner, bankName, iban, bic, date):
        self.owner = owner
    ...
    def __repr__(self) -> str:
        return f"{type(self).__name__}(owner={self.owner}, bank={self.bankName}, iban={self.iban}, bic={self.bic}, date={self.date})"
...
class SepaMember:
    ...
    def __init__(self, id, memberId, firstName, lastName, email, feeType, sepaMandate):
        self.id = id
        ...
        self.sepaMandate = sepaMandate

    def __repr__(self) -> str:
        return f"{type(self).__name__}(id={self.id}, memberId={self.memberId}, fname={self.firstName}, lname={self.lastName}, mail={self.email}, feeType={self.feeType}, sepa={self.sepaMandate})"
